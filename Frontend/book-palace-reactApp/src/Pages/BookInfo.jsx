...
let relatedBooksFind=async()=>{
  try{
    let response=await axios.get(`https://book-palace-full-stack-mern-application-production-1d9c.up.railway.app/books/relatedbook/${book.category}`);
...
useEffect(()=>{
  ...
  const findBook=async()=>{
    try{
        let response=await axios.get(`https://book-palace-full-stack-mern-application-production-1d9c.up.railway.app/books/${id}`);
  ...
  let handleDelete=async()=>{
    try{
      let response=await axios.delete(`https://book-palace-full-stack-mern-application-production-1d9c.up.railway.app/books/delete/${book._id}`,{
